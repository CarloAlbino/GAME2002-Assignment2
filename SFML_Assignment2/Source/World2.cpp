...
World2::World2(sf::RenderTarget& outputTarget, FontHolder& fonts, SoundPlayer& sounds, Player& player, sf::Window& window)
...
bool World2::hasAlivePlayer() const
{
	return !mPlayerAircraft->isMarkedForRemoval();
}

bool World2::hasPlayerReachedEnd() const
{
...
void World2::buildScene()
{
	...
	sf::Texture& lavaTexture = mTextures.get(Textures::Lava);
	...
	std::unique_ptr<SpriteNode> jungleSprite(new SpriteNode(lavaTexture, textureRect));
...
void World2::addEnemies()
{
	// Add enemies to the spawn point container
	addEnemy(Aircraft::Raptor, 0.f, 500.f);
	addEnemy(Aircraft::Raptor, 50.f, 500.f);
	addEnemy(Aircraft::Raptor, 100.f, 500.f);
	addEnemy(Aircraft::Raptor, -50.f, 500.f);
	addEnemy(Aircraft::Avenger, 70.f, 1500.f);
	addEnemy(Aircraft::Avenger, -70.f, 1500.f);
	addEnemy(Aircraft::Avenger, -70.f, 1710.f);
	addEnemy(Aircraft::Avenger, 70.f, 1700.f);
	addEnemy(Aircraft::Avenger, 0.f, 1850.f);
	addEnemy(Aircraft::Raptor, 10.f, 1705.f);
	addEnemy(Aircraft::Raptor, -10.f, 1705.f);
	...
	addEnemy(Aircraft::Raptor, 50.f, 3250.f);
	addEnemy(Aircraft::Raptor, -50.f, 3250.f);
	addEnemy(Aircraft::Avenger, 0.f, 4200.f);
...
void World2::addEnemy(Aircraft::Type type, float relX, float relY)
{
	SpawnPoint spawn(type, mSpawnPosition.x + relX, mSpawnPosition.y - relY);
	mEnemySpawnPoints.push_back(spawn);
}

void World2::spawnEnemies()
{
