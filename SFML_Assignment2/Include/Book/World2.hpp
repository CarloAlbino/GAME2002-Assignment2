#ifndef BOOK_WORLD2_HPP
#define BOOK_WORLD2_HPP
...
{
public:
	World2(sf::RenderTarget& outputTarget, FontHolder& fonts, SoundPlayer& sounds, Player& player, sf::Window& window);
